...
import { getAllQuestions } from "../helpers/Peticiones";
...
export const Formulario = () => {
  ...
  const getQuestions = async () => {
    try {
      let json = await getAllQuestions();
console.log('json')
console.log(json)
      if (json.code === 200) {
        console.log("json.data");
        console.log(json.data);
        setPreguntas(json.data);
      }
    } catch (e) {
      console.log(e);
    }
...
for (var clave in municipios){
  // Controlando que json realmente tenga esa propiedad
  if (municipios.hasOwnProperty(clave)) {
    // Mostrando en pantalla la clave junto a su valor
    // console.log('municipios[clave]')
    // console.log(municipios[clave])
        if(estadoSeleccionado.toUpperCase()===clave.toUpperCase()){
          setState({...state,municipios:municipios[clave]})
        }
  }
}
  ...
  return (
    <div>
      <Container>
        <Row>
          <Button onClick={getQuestions}>Listar preguntas</Button>
          {preguntas.length > 0 &&
            preguntas.map((p) => {
              return <Form.Label key={p.idPregunta}>{p.pregunta}</Form.Label>;
            })}
        </Row>
        <Row>
          <Col sm={4}></Col>
          <Col sm={4}>
            <Form>
              ...
              <Form.Group className="mb-3" controlId="text">
                <Form.Label>
                  11. ¿Qué tipo de dispositivo utilizabas con mayor frecuencia
              ...
              <Form.Group className="mb-3" controlId="text">
                <Form.Label>
                  12. ¿Tuviste la necesidad de comprar algún dispositivo para
                  poder tomar las clases en línea?
                </Form.Label>
                <select>
                  <option value={"si"}>si</option>
                  <option value={"no"}>no</option>
              ...
              <Form.Group className="mb-3" controlId="text">
                <Form.Label>
                  13. ¿En cuál de los siguientes medios entregabas trabajos,
                  actividades escolares? (Selección Múltiple)
                </Form.Label>
                <Form.Check
                  type="switch"
                  id="custom-switch"
                ...
                />
                <Form.Check type="switch" id="custom-switch" label="•	Ninguno" />
                <Form.Check
                  type="switch"
                  id="custom-switch"
                  label="Masculino"
              ...
              <Form.Group className="mb-3" controlId="text">
                ...
                <Form.Check type="switch" id="custom-switch" label="• Mucho" />
                <Form.Check type="switch" id="custom-switch" label="•	Regular" />
                <Form.Check type="switch" id="custom-switch" label="•	Poco" />
                <Form.Check
                  type="switch"
                  id="custom-switch"
                  label="•	Muy poco"
              ...
              <Form.Group className="mb-3" controlId="text">
                <Form.Label>
                  15. ¿Qué sistemas on-line utilizaban los profesores para
                  evaluarte? (Selección Múltiple)
                </Form.Label>
                <Form.Check
                  type="switch"
                  id="custom-switch"
              ...
              <Form.Group className="mb-3" controlId="text">
                <Form.Label>
                  16. Señala los dos sistemas de evaluación on-line que MEJOR
                  valoras (Selección Múltiple)
                </Form.Label>
                <Form.Check
                  type="switch"
                  id="custom-switch"
              ...
              <Form.Group className="mb-3" controlId="text">
                <Form.Label>
                  17. Señala los dos sistemas de evaluación on-line que PEOR
                  valoras (Selección Múltiple)
                </Form.Label>
                <Form.Check
                  type="switch"
              ...
              <Form.Group className="mb-3" controlId="text">
                <Form.Label>
                  18. ¿Qué dificultades llegaste a tener durante tus
                  evaluaciones on-line? (Selección Múltiple)
                </Form.Label>
                <Form.Check
                  type="switch"
                  id="custom-switch"
              ...
              <Form.Group className="mb-3" controlId="text">
                <Form.Label>
                  20. ¿Qué tan fácil era poder aclarar una duda con algún
                  maestro?
                </Form.Label>
                <Form.Check type="switch" id="custom-switch" label="• Mucho" />
                <Form.Check type="switch" id="custom-switch" label="•	Regular" />
              ...
              <Form.Group className="mb-3" controlId="text">
                <Form.Label>
                  22. ¿Cuánto tiempo le dedicabas, de lunes a viernes, a las
                  actividades de aprendizaje (clases, hacer tareas, estudiar,
                  lectura)?
                </Form.Label>
                <Form.Check
                  type="switch"
              ...
              <Form.Group className="mb-3" controlId="text">
                <Form.Label>
                  23. Durante el tiempo de las clases a distancia, crees que
                  aprendiste…
                </Form.Label>
                <Form.Check
                  type="switch"
              ...
              <Form.Group className="mb-3" controlId="text">
                <Form.Label>
                  27. ¿En algún momento te llegaste a sentir agredido en clases
                  virtuales por tus compañeros o compañeras?
                </Form.Label>
                <Form.Check type="switch" id="custom-switch" label="• Mucho" />
                <Form.Check type="switch" id="custom-switch" label="•	Regular" />
                <Form.Check type="switch" id="custom-switch" label="•	Poco" />
              ...
              <Form.Group className="mb-3" controlId="text">
                <Form.Label>
                  28. Durante el confinamiento, qué actividades tuviste que
                  compatibilizar (Respuesta Múltiple)
                </Form.Label>
                <Form.Check type="switch" id="custom-switch" label="•	Estudio" />
                <Form.Check type="switch" id="custom-switch" label="•	Trabajo" />
                <Form.Check
                  type="switch"
                  id="custom-switch"
                  label="•	Apoyo en casa"
                ...
                />
                <Form.Check type="switch" id="custom-switch" label="•	Otros" />
              </Form.Group>
              ...
              <Form.Group className="mb-3" controlId="text">
                <Form.Label>
                  30. Qué aspectos positivos y negativos destacarías de tu
                  trabajo on line durante el confinamiento.
                </Form.Label>
                <Form.Control type="text" placeholder="" />
              </Form.Group>
